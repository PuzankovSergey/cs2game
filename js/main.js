...
let audoi_icon = document.querySelector('.btn__sound i')
...
audio_btn.addEventListener('click', function() {
    if(audio.muted) {
        audio.muted = false
        audoi_icon.classList.add('fa-volume-up')
        audoi_icon.classList.remove('fa-volume-off')
    } else if(!audio.muted) {
        audio.muted = true
        audoi_icon.classList.remove('fa-volume-up')
        audoi_icon.classList.add('fa-volume-off')
    }
})